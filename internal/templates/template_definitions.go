...
<br>{{ trendEmoji "stable" }} **No Go files modified in this PR**
...
*Generated by 📊 [Go Coverage](https://github.com/{{ .Repository.Owner }}/{{ .Repository.Name }})* • *{{ .Metadata.GeneratedAt.Format "2006-01-02 15:04:05 UTC" }}*
{{ else }}
